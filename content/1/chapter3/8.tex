...
\subsubsubsection{3.8.1\hspace{0.2cm}Generating requirements documentation}
...
\subsubsubsection{3.8.2\hspace{0.2cm}Generating diagrams from code}
...
\subsubsubsection{3.8.3\hspace{0.2cm}Generating (API) documentation from code}
