...
\subsubsubsection{7.4.1\hspace{0.2cm}Fetching dependencies}
...
\subsubsubsection{7.4.2\hspace{0.2cm}Using find scriptse}
...
\subsubsubsection{7.4.3\hspace{0.2cm}Writing find scripts}
...
\subsubsubsection{7.4.4\hspace{0.2cm}Using the Conan package manager}
...
\subsubsubsection{7.4.5\hspace{0.2cm}Adding tests}
